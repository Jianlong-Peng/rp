...
#   LastChange: 2014-11-24 16:29:23
#      History:
=============================================================================*/
#include <iostream>
#include <fstream>
...
int operator_type(1);
vector<bool> is_som;
//float (*obj_func)(vector<double>&, vector<PredictResult>&, GA1DArrayGenome<float>&) = obj_1;
bool calc_auc(false);
bool calc_iap(false);
    ...
    while(getline(inf,line)) {
        ...
        if(para == "gapara_file")
            ...
            switch(obj_type) {
                ...
                default: 
                        cerr << "Error: `obj_type` should be 1,2,3,4, but " << obj_type << " is given" << endl;
                        exit(EXIT_FAILURE);
            }
            */
        }
