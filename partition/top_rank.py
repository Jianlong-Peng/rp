...
right   %d
error   %d
"""%(k,total,miss,right,(total-miss-right))
	#print "totally %d samples, of which %d has no SOM labeled, %d has SOM predicted at top-%d"%(total,miss,right,k)
